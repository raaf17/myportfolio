    ...
    return (
        <div className="md:px-20 lg:px-32 px-5">
            <div className="flex flex-wrap gap-2 mb-6 px-6 items-center justify-center">
                ...
                <Button onClick={handleFilter} variant={cate != "php" ? "secondary" : ""} size="sm" className="rounded-full text-xs">php</Button>
                <Button onClick={handleFilter} variant={cate != "mysql" ? "secondary" : ""} size="sm" className="rounded-full text-xs">mysql</Button>
